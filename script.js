const questions = [
    {
        "question": "¿Cuál es el menú para ir a Marca de agua, color de página y bordes de página (Fondo de página)?",
    ...
    {
        "question": "¿Cuál es el menú para ir a columnas y orientación (Configurar página)?",
        "image": "images/1.0.jpg",
        "options": [
            { "text": "Revisar", "isCorrect": false },
            { "text": "Disposición", "isCorrect": true },
            { "text": "Diseño", "isCorrect": false }
        ]
    },
    {
        "question": "¿Cómo se llama el apartado donde se encuentran las columnas y orientación?",
        "image": "images/1.0.jpg",
        "options": [
            { "text": "Diseño", "isCorrect": false },
            { "text": "Configuración", "isCorrect": false },
            { "text": "Configurar página", "isCorrect": true }
        ]
    },
    {
    ...
    {
        "question": "¿Cual es la herramienta de portada?",
